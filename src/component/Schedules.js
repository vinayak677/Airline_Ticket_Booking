  ...
  return (
   ...
   <div className='bg_dot pt100 pb-5'>
        ...
        <div className='container'>
            <div className='carder cards_size d-flex  align-items-center rounded-top-right wow animate__animated animate__fadeInLeft'>
            ...
            <div className='carder cards_size align-items-center wow animate__animated animate__fadeInLeft'>
